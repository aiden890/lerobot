python3 -m lerobot.scripts.lerobot_inference_without_robot \
    --robot.type=so100_follower \
    --dataset.repo_id=khmin101/eval_test \
    --dataset.single_task=single \
    --robot.port=none \
    --policy.type=pi0
...
#                                           [--robot.left_arm_disable_torque_on_disconnect str] [--robot.left_arm_max_relative_target str]
#                                           [--robot.left_arm_use_degrees str] [--robot.right_arm_disable_torque_on_disconnect str]
#                                           [--robot.right_arm_max_relative_target str] [--robot.right_arm_use_degrees str] [--robot.side str]
...
#                                           [--robot.use_degrees str] [--dataset str] [--dataset.repo_id str] [--dataset.single_task str]
#                                           [--dataset.root str] [--dataset.fps str] [--dataset.episode_time_s str]
#                                           [--dataset.reset_time_s str] [--dataset.num_episodes str] [--dataset.video str]
#                                           [--dataset.push_to_hub str] [--dataset.private str] [--dataset.tags str]
...
#                                           [--teleop.left_arm_port str] [--teleop.right_arm_port str] [--teleop.side str]
#                                           [--teleop.baud_rate str] [--teleop.gripper_open_pos str] [--teleop.port str]
#                                           [--teleop.use_degrees str] [--teleop.id str] [--teleop.calibration_dir str]
#                                           [--teleop.use_gripper str] [--policy str]
...
#                                           [--policy.clip_sample_range str] [--policy.do_mask_loss_for_padding str]
#                                           [--policy.scheduler_name str] [--policy.image_size str] [--policy.base_model_path str]
#                                           [--policy.tokenizer_assets_repo str] [--policy.embodiment_tag str] [--policy.tune_llm str]
#                                           [--policy.tune_visual str] [--policy.tune_projector str] [--policy.tune_diffusion_model str]
#                                           [--policy.lora_rank str] [--policy.lora_alpha str] [--policy.lora_dropout str]
#                                           [--policy.lora_full_model str] [--policy.warmup_ratio str] [--policy.use_bf16 str]
#                                           [--policy.video_backend str] [--policy.balance_dataset_weights str]
#                                           [--policy.balance_trajectory_weights str] [--policy.dataset_paths str] [--policy.output_dir str]
#                                           [--policy.save_steps str] [--policy.max_steps str] [--policy.batch_size str]
#                                           [--policy.dataloader_num_workers str] [--policy.report_to str] [--policy.resume str]
#                                           [--policy.paligemma_variant str] [--policy.action_expert_variant str] [--policy.dtype str]
#                                           [--policy.num_inference_steps str] [--policy.time_sampling_beta_alpha str]
#                                           [--policy.time_sampling_beta_beta str] [--policy.time_sampling_scale str]
#                                           [--policy.time_sampling_offset str] [--policy.image_resolution str]
#                                           [--policy.gradient_checkpointing str] [--policy.compile_model str] [--policy.compile_mode str]
#                                           [--policy.chunk_size str] [--policy.max_state_dim str] [--policy.max_action_dim str]
#                                           [--policy.resize_imgs_with_padding str] [--policy.empty_cameras str]
#                                           [--policy.adapt_to_pi_aloha str] [--policy.use_delta_joint_actions_aloha str]
#                                           [--policy.tokenizer_max_length str] [--policy.num_steps str] [--policy.use_cache str]
#                                           [--policy.train_expert_only str] [--policy.train_state_proj str]
#                                           [--policy.optimizer_grad_clip_norm str] [--policy.scheduler_decay_steps str]
...
#                                           [--policy.horizon str] [--policy.n_action_steps str] [--policy.q_ensemble_size str]
#                                           [--policy.mlp_dim str] [--policy.use_mpc str] [--policy.cem_iterations str] [--policy.max_std str]
...
#                                           [--policy.sequentially_select str] [--policy.optimizer_lr str] [--policy.optimizer_betas str]
...
#                                           [--policy.num_discrete_actions str] [--policy.online_steps str]
...
#                                           [--policy.use_torch_compile str] [--policy.n_obs_steps str] [--policy.input_features str]
#                                           [--policy.output_features str] [--policy.device str] [--policy.use_amp str]
#                                           [--policy.push_to_hub str] [--policy.repo_id str] [--policy.private str] [--policy.tags str]
#                                           [--policy.license str] [--policy.pretrained_path str] [--policy.name str]
#                                           [--policy.num_classes str] [--policy.hidden_dim str] [--policy.latent_dim str]
#                                           [--policy.image_embedding_pooling_dim str] [--policy.dropout_rate str] [--policy.model_name str]
#                                           [--policy.model_type str] [--policy.num_cameras str] [--policy.learning_rate str]
#                                           [--policy.weight_decay str] [--policy.grad_clip_norm str] [--policy.normalization_mapping str]
#                                           [--display_data str] [--play_sounds str] [--resume str]