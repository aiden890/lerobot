...
def decode_video_frames(
    ...
    if backend == "torchcodec":
        ...
        if torchvision is None:
            raise ImportError(
                f"torchvision is required to decode videos with the '{backend}' backend. "
                "Install torchvision or choose a different backend."
            )
...
def decode_video_frames_torchvision(
    ...
    if torchvision is None:
        raise ImportError(
            f"torchvision is required to decode videos with the '{backend}' backend. "
            "Install torchvision or select the 'torchcodec' backend instead."
        )
